...
//!
//! The pick stack is only the requested-target card.
//! The compose stack gets the chosen toolchain as a fact, or the requested
//! target when there is no catalog row.
